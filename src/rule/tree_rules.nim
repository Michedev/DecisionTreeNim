...
type 
    ...
    PostSplitRule* = proc(n: INode, X: MatrixView[float32], y: VectorView[float32], X1: MatrixView[float32], y1: VectorView[float32], X2: MatrixView[float32], y2: VectorView[float32]): bool {.gcsafe.}
...
proc any_true(rules: sink seq[Rule], n: INode, X: MatrixView[float32], y: VectorView[float32]): bool {.gcsafe.} =
    for rule in rules:
        if rule(n, X, y):
...
proc any_true(rules: seq[PostSplitRule], n: INode, X: MatrixView[float32], y: VectorView[float32], X1: MatrixView[float32], y1: VectorView[float32], X2: MatrixView[float32], y2: VectorView[float32]): bool {.gcsafe.} =
    for rule in rules:
...
proc on_post_split*(tsr: TreeStopRules, n: INode, X: MatrixView[float32], y: VectorView[float32], X1: MatrixView[float32], y1: VectorView[float32], X2: MatrixView[float32], y2: VectorView[float32]): bool {.gcsafe.} =
